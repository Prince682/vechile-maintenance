...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfo("Vehicle Maintenance Application", "Test Application", "v1", null,
				new Contact("Prince", "", "psinha691@gmail.com"), "API License", "API License URL",
